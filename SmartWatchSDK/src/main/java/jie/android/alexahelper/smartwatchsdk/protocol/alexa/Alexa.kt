...
open class Protocol constructor(val type:String, val source: JsonObject, val header: JsonObject, val payload: JsonObject? = null, val context: Any? = null) {
...
open class Event (source: JsonObject, header: JsonObject, payload: JsonObject? = null, context: Any? = null):
    Protocol("event", source, header, payload, context) {
...
open class Directive (source: JsonObject, header: JsonObject, payload: JsonObject? = null, context: Any? = null):
    Protocol("directive", source, header, payload, context) {
